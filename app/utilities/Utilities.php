...
class Utilities
{
    ...
    public static function SaveToErrorLog($message, $level = 'info', $name='Generic')
    {
        ...
        $errorLog->pushHandler(new StreamHandler(__DIR__ . '/../../' . $_ENV['AITS_STUDENT_ENROLLMENT_APP_DATA_LOG_RELATIVE_PATH'] . '/' . $_ENV['AITS_STUDENT_ENROLLMENT_APP_DATA_LOG_FILE_PREFIX'] . 'error.log', constant('Monolog\Logger::' . strtoupper($level))));
